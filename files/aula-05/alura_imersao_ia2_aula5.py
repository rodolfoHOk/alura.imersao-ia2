# -*- coding: utf-8 -*-
"""alura-imersao-ia2-aula-5.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1CpE2PlHHRs6UninfsgHf1wS8ehqmoTLC
...
"""### Criando função de gerar embedding da consulta e buscar nos documentos"""
...
"""### Consultando texto nos documentos"""
...
prompt_base = "Reescreva esse texto de uma forma mais descontraída, sem adicionar informações que não façam parte do texto:"

response = gen_model.generate_content((f"{prompt_base} {trecho}"))
